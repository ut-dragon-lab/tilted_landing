...
for PITCH in "${ANGULOS[@]}"; do
	...
	TARGET_X=$(LC_NUMERIC=C awk "BEGIN {print 1.0 + ${NOISE_X[$RUN]}}")
        TARGET_Y=$(LC_NUMERIC=C awk "BEGIN {print 1.0 + ${NOISE_Y[$RUN]}}")
	...
	sleep 5
        ...
        # Inicia o gravador ROSBAG apenas para o topico de controle (para o grafico de jitter)
        ...
        # Passamos parametros para o python salvar com o nome correto
        ...
        # =========================================================
        echo "Gerando gráficos da rodada..."
